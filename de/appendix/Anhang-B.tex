...
%kapitel VII
\section{Die Fourieranalyse -- Ordnung in komplexen Signalen}
...
\begin{MathBox}[Matheboxen]
	\begin{itemize}
		\item \emph{Die Sinusfunktion als Grundbaustein}\dotfill \pageref{box:fourier-sinus-grundbaustein}
	\end{itemize}
\end{MathBox}

\begin{DidacticBox}[Didaktikboxen]
	\begin{itemize}
		\item \emph{Was ist ein komplexes Signal?}\dotfill \pageref{box:fourier-komplexes-signal}
		\item \emph{Was bedeutet „harmonische Schwingung“?}\dotfill \pageref{box:fourier-harmonische-schwingung}
		\item \emph{Überlagerung von Wellen}\dotfill \pageref{box:fourier-ueberlagerung-wellen}
		\item \emph{Warum Fouriers Idee revolutionär war}\dotfill \pageref{box:fourier-revolutionaere-idee}
		\item \emph{Frequenzen in Bildern}\dotfill \pageref{box:fourier-frequenzen-in-bildern}
		\item \emph{Das Gibbs-Phänomen}\dotfill \pageref{box:fourier-gibbs-phaenomen}
		\item \emph{Fourier-Theorie in der Quantenmechanik}\dotfill \pageref{box:fourier-quantenmechanik}
	\end{itemize}
\end{DidacticBox}

\begin{PhysicsBox}[Physikboxen]
	\begin{itemize}
		\item \emph{Mathematik macht den Körper sichtbar}\dotfill \pageref{box:fourier-medizinische-bildgebung}
		\item \emph{Spektrallinien als mathematische Signatur}\dotfill \pageref{box:fourier-spektrallinien-signatur}
	\end{itemize}
\end{PhysicsBox}

\begin{NoteBox}[Hinweisboxen]
	\begin{itemize}
		\item \emph{Ausgangspunkt der Fourieranalyse}\dotfill \pageref{box:fourier-ausgangspunkt-waermeleitung}
		\item \emph{Vertiefung: Rechtecksignal}\dotfill \pageref{box:fourier-vertiefung-rechtecksignal}
		\item \emph{Zeitbereich und Frequenzbereich}\dotfill \pageref{box:fourier-zeitbereich-frequenzbereich}
		\item \emph{Musiknoten als mathematische Ordnung}\dotfill
		 \pageref{box:Musiknoten}
		\item \emph{Fourieranalyse als Grundlage der digitalen Welt}\dotfill \pageref{box:fourier-digitale-welt}
		\item \emph{Mathematische Ordnung hinter\newline komplexen Phänomenen}\dotfill \pageref{box:fourier-mathematische-ordnung}
	\end{itemize}
\end{NoteBox}
...
\begin{HistoryBox}[Historische Boxen]
	...
	\begin{itemize}
		...
		\item \emph{Immanuel Kant und  die \glqq Kritik der \newline reinen Vernunft\grqq}\dotfill \pageref{box:kant-krv}
	\end{itemize}
\end{HistoryBox}
...
\begin{NoteBox}[Hinweisboxen]
	...
	\begin{itemize}
		\item \emph{Die Biene rechnet nicht -- aber die \newline Struktur entsteht}\dotfill \pageref{box:biene-struktur}
...
\begin{DidacticBox}[Didaktikboxen]
	\begin{itemize}
		...
		\item \emph{Warum Seifenhäute mathematisch \newline interessant sind}\dotfill \pageref{box:seifenhaut}
...
\section{Anhang A -- Mathematische Hintergründe und Herleitungen}
...
\begin{MathBox}[Matheboxen]
	\begin{itemize}
		...
		\item \emph{Escape-Radius \(R=2\)}\dotfill \pageref{box:mandelbrot-escape-radius}
		\item \emph{Vom Draht zum Rohr: der entscheidende Schritt}\dotfill \pageref{box:draht-rohr}
		\item \emph{Grundidee der Fourieranalyse}\dotfill \pageref{box:anhangA-fourier-grundidee}
		\item \emph{Orthogonalität von Funktionen}\dotfill \pageref{box:anhangA-fourier-orthogonalitaet}
		\item \emph{Fourier-Reihe des Rechtecksignals}\dotfill \pageref{box:anhangA-fourier-rechteckreihe}
	\end{itemize}
\end{MathBox}
...
\begin{DidacticBox}[Didaktikboxen]
	\begin{itemize}
		...
		\item \emph{Warum diese „Log-Log“-Formel?}\dotfill \pageref{box:mandelbrot-loglog}
		\item \emph{Merksatz: Nicht Strings im Gehirn -- sondern \newline Flächen-Optimierung}\dotfill \pageref{box:stringtheorie-flaechenoptimierung}
		\item \emph{Warum diese Formeln funktionieren}\dotfill \pageref{box:anhangA-fourier-koeffizienten}
		\item \emph{Gibbs-Phänomen}\dotfill \pageref{box:anhangA-fourier-gibbs}
	\end{itemize}
\end{DidacticBox}

\begin{PhysicsBox}[Physikboxen]
	\begin{itemize}
		\item \emph{Rechtecksignal und Bandbreite}\dotfill \pageref{box:anhangA-fourier-bandbreite}
	\end{itemize}
\end{PhysicsBox}
...
\begin{NoteBox}[Hinweisboxen]
	\begin{itemize}
		\item \emph{Typisches Standardfenster}\dotfill \pageref{box:mandelbrot-standardfenster}
		\item \emph{Wichtig für den Leser}\dotfill \pageref{box:mandelbrot-leserhinweis}
		\item \emph{Ordnung hinter der Form}\dotfill \pageref{box:anhangA-fourier-ordnung-form}
	\end{itemize}
\end{NoteBox}