...
Jetzt folgt der entscheidende Schritt: Was heißt „beschränkt“, was heißt „divergent“ --
und warum sitzt die Struktur genau am Rand dazwischen?
% =====================================================
...
findet sich in Anhang~\ref{app:mandelbrot-rendering}.
 ...
 Julia-Mengen sind die Landkarten des \emph{Zustandsraums}: Für ein festes \(c\) zeigt sich,
 welche Startwerte \(z_0\) gebunden bleiben und welche entkommen.
...
Sie zeigen, wie aus einer einfachen mathematischen Vorschrift \emph{Struktur ohne Materie} entsteht --
als Grenzobjekt zwischen Stabilität und Chaos.
