...
\subsection{Computer: Beweis, Simulation, experimentelle Marhemathik}
...
\subsection{KI: Werkzeug,Muster,Hallutination, Verantwortung}
...
\subsection{Mathematik und moderne Physik: Symmetrien, QFT, Information}
...
\index{Baum}
\index{Evolution}
\subsection{Bienenwaben: Geometrie als Leichtbauprinzip}
\subsubsection*{Bienenwaben: Geometrie als Leichtbauprinzip}
Bienenwaben sind nahezu sechseckig. Das ist keine ``Dekoration'', sondern eine geometrische Effizienz:
Regelmäßige Sechsecke können eine Fläche lückenlos füllen und sind unter den regelmäßigen Pflasterungen
(Dreieck, Quadrat, Sechseck) die ``rundeste'' Form. Für eine gegebene Zellgröße wird dadurch wenig Wandlänge benötigt,
also wenig Material.

Genau dieses Prinzip nutzt der technische Leichtbau. In der Luftfahrt dienen Wabenkernen (Honeycomb) als Kern von
Sandwich-Bauteilen: Zwei dünne, feste Decklagen werden durch den leichten Kern auf Abstand gehalten.
Der Kern stabilisiert gegen Beulen und nimmt Schubkräfte auf, während die Decklagen Zug und Druck bei Biegung tragen.
Das Ergebnis ist eine sehr hohe Biegesteifigkeit bei minimalem Gewicht -- ein klassisches Beispiel dafür,
wie reine Geometrie zur tragenden Ingenieurstruktur wird.
\begin{NoteBox}[Die Biene rechnet nicht -- aber die Struktur entsteht]
	\small
	Die Wabe ist ein Beispiel dafür, dass Mathematik nicht erst im Kopf beginnt.
	Die Welt selbst „kennt“ Strukturen: Wenn Material, Kräfte und Randbedingungen zusammenwirken,
	tauchen stabile geometrische Muster auf.
	Mathematik ist dann nicht Erfindung, sondern das präzise Instrument, mit dem wir diese Struktur
	\emph{erkennen, benennen und technisch nutzen} -- vom Bienenstock bis zur Sandwichstruktur im Leichtbau.
\end{NoteBox}
\begin{figure}[htbp]
	\centering
